...
要件整理から実装着手までをAIエージェントと進めたい人向けのテンプレートです。
...
4. 文書が固まったら、必要な実装や技術スタックの初期化に進む
5. 実装を始めたら、`README.md`、`docs/project-spec.md`、`ARCHITECTURE.md` を実態に合わせて更新し続ける
...
- `.gitignore` は最小限から始め、採用スタックや生成物に応じて追加する

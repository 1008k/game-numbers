...
## [Unreleased]
- 具体プロジェクト固有の記述を外し、汎用 `docs-first` テンプレートとして使える文書構成へ戻した
- ブラウザ向けUI案件向けに `Modern Web Guidance` の導入メモを追加し、Web標準、性能、アクセシビリティ、セキュリティの最小ルールを整理
...
- 大きめの変更を残す `docs/tracks/` テンプレートを追加し、ADR前提の運用を外した
